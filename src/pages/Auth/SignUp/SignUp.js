...
const SignUp = () => {
  ...
  const onSubmit = (data) => {
    apiInstance
      .post("/frontend/auth/register", data)
      .then((res) => {
        const { data } = res?.data;
        if (data) {
          navigate("/");
      ...
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        >
          <div className="flex flex-col gap-4 p-4 md:p-8">
            ...
            <button
              type="submit"
              className="block rounded-lg bg-emerald-400 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base"
            >
              Sign Up
            </button>
