...
const Product = (props) => {
  ...
  return (
    <div className="w-full relative group flex flex-col h-full">
      ...
      <div className="py-6 flex flex-col gap-1 border-[1px] border-t-0 px-4">
        <h4
          ...
          className="text-sm text-primeColor font-bold"
        >
          {props.productName}
        </h4>
        ...
        <div className="flex justify-between">
          ...
          <p className="text-[#767676] text-[14px]">{props?.subCategory}</p>
        </div>
        <div className="flex justify-between">
          <p className="text-[#767676] text-[14px]">{props?.brand}</p>
        </div>
        <div>
          <p className="text-[#767676] text-[14px]">
            {props?.cartoncapacity} / {props?.unit}
          </p>
        </div>
      </div>
    </div>
