...
const Pagination = ({ itemsPerPage, handleItemPerPage }) => {
  ...
  const selectedCategories = useSelector(
    (state) => state.orebi.checkedCategories
  );
    ...
    <div>
      ...
      <div className="flex flex-col mdl:flex-row justify-center mdl:justify-between items-center">
        ...
        <div className="flex gap-4">
          <p className="text-base font-normal text-lightText">Show:</p>
          <select
          ...
          <p className="text-base font-normal text-lightText">per page</p>
        </div>
      </div>
    </div>
  );
